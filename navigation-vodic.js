window.addEventListener("load", function () {
    ...
    const clickHandler = (link) => {
        if (link == "link-1") {
            ...
            navigationLink4.classList.remove(
                "section-content__navigation__item__selected"
            );
            navigationLink5.classList.remove(
                "section-content__navigation__item__selected"
            );
    ...
    navigationLink4.addEventListener("click", () => {
        clickHandler("link-4");
    });
    navigationLink5.addEventListener("click", () => {
        clickHandler("link-5");
    });
    ...
    headerLinkFooter4.addEventListener("click", () => {
        clickHandler("link-4");
    });
    headerLinkFooter5.addEventListener("click", () => {
        clickHandler("link-5");
    });
    ...
    headerLinkHam4.addEventListener("click", () => {
        clickHandler("link-4");
        burgerHandler();
    });
    headerLinkHam5.addEventListener("click", () => {
        clickHandler("link-5");
        burgerHandler();
    });
