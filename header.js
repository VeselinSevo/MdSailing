        ...
        if (!burger) {
            if (type == "vodic") {
                if (
                    ...
                    pustolovineArrow.classList.toggle(
                        "header__item__arrow__show"
                    );
                }

                if (
                    jeziciMenu.classList.contains("header__jezici-menu__shown")
                ) {
            ...
            if (type == "vodic") {
                ...
                if (
                    jeziciHamburgerArrow.classList.contains(
                        "header__item__arrow__show"
                    )
                ) {
                    ...
                    jeziciHamburgerArrow.classList.toggle(
                        "header__item__arrow__show"
                    );
                }
                ...
                vodicHamburgerArrow.classList.toggle(
                    "header__item__arrow__show"
                );
            } else if (type == "pustolovine") {
                if (
                    vodicHamburgerArrow.classList.contains(
                        "header__item__arrow__show"
                    )
                ) {
                    vodicHamburgerMenu.classList.toggle(
